...
- a select with the options: My Permissions, Full Permission Tree, Search => default to My Permissions. When search is selected, user can input text in the same component to filter per did or grantee account
...
- ecosystem name
- the credential schema title
- Participants (click returns to above view)
